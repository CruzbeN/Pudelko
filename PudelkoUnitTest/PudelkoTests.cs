    ...
    public class PudelkoTests
    {
        ...
        public class UnitTestsPudelkoConstructors
        {
            ...
            [DataRow(100, 255, 3,
                     0.1, 0.255, 0.003)]
            [DataRow(100.0, 25.58, 3.13,
                     0.1, 0.026, 0.003)] // dla milimetrów nie licz¹ siê miejsca po przecinku
            ...
            public static IEnumerable<object[]> DataSet1Meters_ArgumentOutOfRangeEx => new List<object[]>
        {
            ...
            #region Pole, Objêtoœæ ===================================
                        ...
                        [DataRow(5.79, 1.39, 7.346, 59.1213426)]
                        [DataRow(3.5, 3.946, 1.6, 22.0976)]
                        [DataRow(5.14, 3.423, 1.777, 31.26492894)]
            ...
            [DataTestMethod, TestCategory("Box area: ")]
            [DataRow(3,3,3,54)]
            [DataRow(3,4,5,94)]
            ...
            [DataRow(5, 4.3, 2.5, 2.5, 5, 4.3)]
            [DataRow(7.83, 1.25, 3.83, 1.25, 3.83, 7.83)]
            ...
            [DataTestMethod, TestCategory("Equals method tests")]
            [DataRow(391, 145, 298, 3910, 1450, 2980)]
            [DataRow(987, 7.2, 155, 9870, 72, 1550)]
            ...
            [DataTestMethod, TestCategory("Equals method tests")]
            [DataRow(6.54, 2, 3, 6540, 2000, 3000)]
            [DataRow(1, 4, 5, 1000, 4000, 5000)]
            ...
            [DataTestMethod, TestCategory("Opeartor equals tests")]
            [DataRow(391, 145, 298, 3910, 1450, 2980)]
            [DataRow(987, 7.2, 155, 9870, 72, 1550)]
            public void OperatorEqualTest(double a, double b, double c, double a1, double b1, double c1)
            {
                Pudelko x = new Pudelko(a, b, c, UnitOfMeasure.centimeter);
                Pudelko y = new Pudelko(a1, b1, c1, UnitOfMeasure.milimeter);
            ...
            [DataTestMethod, TestCategory("Operator NOT equals tests")]
            [DataRow(6.54, 2, 3, 6540, 2000, 3000)]
            [DataRow(1, 4, 5, 1000, 4000, 5000)]
            public void OperatorNOTEqualTest(double a, double b, double c, double a1, double b1, double c1)
            {
                Pudelko x = new Pudelko(a, b, c, UnitOfMeasure.meter);
                Pudelko y = new Pudelko(a1, b1, c1, UnitOfMeasure.milimeter);
